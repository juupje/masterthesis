...
N_DATA_BACKGROUND_TRAIN = 995_000*factor # taken from data-bg
N_DATA_SIGNAL_TRAIN = 5_000*factor # taken from data-sn
...
TAG = "full_test_reduce_LR"
COMMENT = 'Replica of R228; Simple ReduceOnPlateau LR schedule (from paper)'
