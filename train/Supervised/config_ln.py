...
PREPROCESSED_DATA_BG  = f"{directory}/qcd_train_nonan.h5"
PREPROCESSED_DATA_SN = f"{directory}/top_train_nonan.h5"
PREPROCESSED_DATA_BG_TEST = f"{directory}/qcd_test_nonan.h5"
PREPROCESSED_DATA_SN_TEST = f"{directory}/top_test_nonan.h5"
...
TAG = "PL_full_varN"
COMMENT = f"Large-data test of {MODELNAME} performance on sampled qcd vs sampled top data"
...
GRID = create_grid("N={N:d}".format, {"N": [1, 2, 10, 20, 40, 128]})