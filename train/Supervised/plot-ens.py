...
def plot(outdir:str, model_name:str="Model", prediction_files:dict=None,config:dict=None, extra_info:dict=None,
         plot_score_hist:bool=False, store_format:str='png', save:str=None):
...
if __name__=="__main__":
    ...
    plot(outdir, model_name=config["MODELNAME"],
        prediction_files={l: os.path.join(outdir, "*", f"pred_{l}.h5") for l in args['label']}, config=config,
