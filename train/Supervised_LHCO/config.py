...
JET_NOISE = None#{"index": 0, "type": 'mean'}
...
TAG = f"LN_sharedweights"
COMMENT = f"Testing shared weights with {MODELNAME}"
...
GRID = create_grid("shared={SHARED_WEIGHTS}".format, {"SHARED_WEIGHTS": [True, False]})