FEATURES = [0,1,6] #eta, phi, log(pt), log(e), pt/pt_jet, e/e_jet, log(pt/pt_jet), log(e/e_jet), deltaR
N_FEATURES = 3 #eta, phi, log(pt), log(E), log(pt/pt_jet), log(E/E_jet), deltaR
